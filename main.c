...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    while (1) {
        ...
        if (TestMode == 0){clock.seconds = GLOBALsecs;} //updates the clock.seconds to be in sync with clock time when test mode is activated. When test mode is on we shall just freeze the seconds for visual pleasure. 
