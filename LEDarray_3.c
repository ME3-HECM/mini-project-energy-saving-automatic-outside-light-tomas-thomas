...
//{
//    // show maximum and current value 
//    // now need to make the 1 second peak tracker
//   
////    MaxVal = number ;
//    
//    // need to figure out what Max number position to turn on 
//
////    if (number > MaxVal){
////        MaxVal = number;
////    }
...
//
////
////    if ((max > step*1) && (max <= step*2)){temp = 0b000000001 ;} 
////
////    if ((max > step*2) && (max <= step*3)){ temp = 0b000000010 ;} 
////   
////    if ((max > step*3) && (max <= step*4)){ temp = 0b000000100 ; } 
////
////    if ((max > step*4) && (max <= step*5)){ temp = 0b000001000 ;} 
////    
////    if ((max > step*5) && (max <= step*6)){ temp = 0b000010000 ;} 
////
////    if ((max > step*6) && (max <= step*7)){ temp = 0b000100000 ;} 
////
////    if ((max > step*7) && (max <= step*8)){ temp = 0b001000000 ;} 
////
////    if ((max > step*8) && (max <= step*9)){ temp = 0b010000000 ;} 
////    
////    if (max > step*9){ temp = 0b100000000 ; } 
//// 
////    
////    if (temp & 0b000000001){ LATGbits.LATG0 = 1 ; } 
////    else{LATGbits.LATG0 = 0;}
////    
////    if (temp & 0b000000010){ LATGbits.LATG1 = 1 ; } 
////    else{LATGbits.LATG1 = 0;}
////    
////    if (temp & 0b000000100){ LATAbits.LATA2 = 1 ; } 
////    else{LATAbits.LATA2 = 0;}
////    
////    if (temp & 0b000001000){ LATFbits.LATF6 = 1 ; } 
////    else{LATFbits.LATF6 = 0;}
////    
////    if (temp & 0b000010000){ LATAbits.LATA4 = 1 ; } 
////    else{LATAbits.LATA4 = 0;}
////    
////    if (temp & 0b000100000){ LATAbits.LATA5 = 1 ; } 
////    else{LATAbits.LATA5 = 0;}
////    
////    if (temp & 0b001000000){ LATFbits.LATF0 = 1 ; } 
////    else{LATFbits.LATF0 = 0;}
////    
////    if (temp & 0b010000000){ LATBbits.LATB0 = 1 ; } 
////    else{LATBbits.LATB0 = 0;}
////    
////    if (temp & 0b100000000){ LATBbits.LATB1 = 1 ; } 
////    else{LATBbits.LATB1 = 0;}
////    
////    temp = temp>>1 ;
////
